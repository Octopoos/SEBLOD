...
echo JCckDev::getForm(
	...
	array( 'after'=>'<small class="switch notice">'.Text::_( 'COM_CCK_FIELD_WILL_NOT_BE_LINKED' ).Text::_( 'COM_CCK_FIELD_WILL_BE_LINKED' ).'</small><p class="text-center storage-target"><span class="icon-arrow-down"></span></p>' ),
	'w100'
);
?>