...
class pkg_cckInstallerScript
{
	...
	function postflight( $type, $parent )
	{
		...
		<div class="well">
			<a class="btn btn-small btn-success" href="https://www.seblod.com/store" target="_blank"><span class="icon-puzzle"></span> <?php echo JText::_( 'LIB_CCK_INSTALLATION_SEBLOD_MARKETPLACE' ); ?></a>
			<a class="btn btn-small btn-primary" href="https://www.seblod.com/resources/manuals" target="_blank"><span class="icon-book"></span> <?php echo JText::_( 'LIB_CCK_INSTALLATION_SEBLOD_DOCUMENTATION' ); ?></a>
			<a class="btn btn-small btn-info" href="https://www.seblod.com/resources/videos" target="_blank"><span class="icon-play-circle"></span> <?php echo JText::_( 'LIB_CCK_INSTALLATION_SEBLOD_VIDEOS' ); ?></a>
			<a class="btn btn-small" href="https://www.seblod.com/changelogs" target="_blank"><span class="icon-file-2"></span> <?php echo JText::_( 'LIB_CCK_INSTALLATION_LATEST_CHANGELOG' ); ?></a>
		</div>
