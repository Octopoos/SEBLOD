...
<thead>
    <tr>
        ...
        <th class="center" colspan="2"><?php echo HTMLHelper::_( 'grid.sort', 'COM_CCK_TITLE', 'title', $listDir, $listOrder ); ?></th>
		...
		<th width="15%" class="center hidden-phone nowrap"><?php echo Text::_( 'COM_CCK_ADMIN_FORM' ); ?></th>
		<th width="15%" class="center hidden-phone nowrap"><?php echo Text::_( 'COM_CCK_SITE_FORM' ); ?></th>
...
foreach ( $this->items as $i=>$item ) {
    ...
    $link2			=	Route::_( 'index.php?option='.$this->option.'&view=form&type='.$item->name.'&return=cck&return_v=types' );
    ...
    <tr class="row<?php echo $i % 2; ?>">
		...
		<td class="center hidden-phone"><?php echo ( ! $item->adminFields ) ? '-' : '<a class="edit-view" href="'.$link.'&client=admin">'.$item->adminFields.' '.Text::_( 'COM_CCK_FIELDS' ).'</a>'; ?></td>
        <td class="center hidden-phone"><?php echo ( ! $item->siteFields ) ? '-' : '<a class="edit-view" href="'.$link.'&client=site">'.$item->siteFields.' '.Text::_( 'COM_CCK_FIELDS' ).'</a>'; ?></td>
