...
$action_attr	=	' title="'.Text::_( 'COM_CCK_REVERT_TO_THIS_VERSION' ).'"';
...
Text::script( 'COM_CCK_CONFIRM_RESTORE_VERSION' );
...
<div class="<?php echo $this->css['items']; ?>">
	...
	<thead>
		<tr class="half">
			...
			<th width="20%" class="center hidden-phone nowrap" colspan="2" rowspan="2"><?php echo HTMLHelper::_( 'grid.sort', 'COM_CCK_VERSION', 'a.date_time', $listDir, $listOrder ); ?></th>
            <th width="40%" class="center hidden-phone nowrap" colspan="5"><?php echo Text::_( 'COM_CCK_DETAILS' ); ?></th>
		...
		<tr class="half">
			<th width="15%" class="center hidden-phone nowrap"><?php echo Text::_( 'COM_CCK_TITLE_NAME' ); ?></th>
			<th width="25%" class="center hidden-phone nowrap" colspan="4"><?php echo Text::_( 'COM_CCK_FIELDS' ); ?></th>
		</tr>
	</thead>
    <tbody>
	<?php
	...
	foreach ( $this->items as $i=>$item ) {
		...
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td width="4%" class="center">
				<strong><?php echo Text::_( 'COM_CCK_REVISION_SHORT' ) .'<br />'. $item->e_version; ?></strong>
			</td>
			<td class="center hidden-phone"><?php echo HTMLHelper::_( 'date', $item->date_time, Text::_( 'DATE_FORMAT_LC4' ).' H:i' ).( ( $item->user_id > 0 ) ? '<br />'.$item->created_by : '' ); ?></td>
