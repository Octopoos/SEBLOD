...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		echo '<li><label>'.JText::_( 'COM_CCK_SHOW_DESCRIPTION_ALT' ).'</label>'
		 ...
		 echo JCckDev::renderForm('core_dev_text', @$options2['image_watermark'], $config, array('label' => JText::_('COM_CCK_IMAGE_WATERMARK'), 'storage_field' => 'json[options2][image_watermark]'));
