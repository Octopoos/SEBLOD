...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		echo '<li><label>'.JText::_( 'COM_CCK_LEGAL_EXTENSIONS' ).'</label>'
		 .	 JCckDev::getFormFromHelper( array( 'component'=>'com_cck', 'function'=>'getMediaExtensions', 'core_options_media_extensions' ), $media_ext, $config, array( 'defaultvalue'=>'image', 'options'=>'image', 'storage_field'=>'json[options2][media_extensions]' ) )
