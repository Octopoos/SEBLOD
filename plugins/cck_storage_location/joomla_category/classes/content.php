...
class JCckContentJoomla_Category extends JCckContentJoomla_CategoryPlaceholder
{
	...
	{
		$result	=	$this->_triggerEvent( self::$objects[$this->_object]['properties']['events'][$event], array( self::$objects[$this->_object]['properties']['context'], $this->_instance_base, $this->_is_new, $this->getData() ) );
